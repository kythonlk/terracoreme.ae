      ...
      <div className="mx-4 sm:mx-20 px-2 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="mx-2 md:mx-12 flex flex-col items-start justify-start">
            <div className="mb-12 flex flex-col items-start justify-center font-bp">
              <h2 className="text-4xl font-bold mb-6">
                Ready to start your Project?
              </h2>
              <h2 className="text-3xl font-bold fi">Get in touch with our experts</h2>
            </div>
            <form className="space-y-4 bg-white rounded-lg shadow-lg p-8 h-full min-w-[500px]">
